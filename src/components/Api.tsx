...
export const Api = (props: apiProps) => {
    ...
    return (
        <>
        {content.map((item) =>  (
                <Card style={{ width: '8rem', height: "12rem" , backgroundColor: "#131516"}}>
                    <Card.Img variant="top" src={`https://image.tmdb.org/t/p/original${item.poster_path}`} style={ {width: 80, height: 100, alignSelf: "center"}}/>
                    <Card.Body>
